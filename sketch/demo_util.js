 ...
 */
export function drawKeypoints(n, keypoints, minConfidence, ctx, scale = 1) {
  let color;
  for (let i = 0; i < keypoints.length; i++) {
    ...
    color = CSS_COLOR_NAMES[n%CSS_COLOR_NAMES.length]
 ...
 */
export function drawSkeleton(n, keypoints, minConfidence, ctx, scale = 1) {
  const adjacentKeyPoints = posenet.getAdjacentKeyPoints(
    keypoints, minConfidence);
  
  let  color = CSS_COLOR_NAMES[n%CSS_COLOR_NAMES.length]
